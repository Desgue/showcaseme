...
export function HeroSectionComponent({ t }: HeroSectionProps) {
  return (
    <section className="h-screen flex items-center justify-center relative overflow-hidden  bg-gradient-to-b from-white via-gray-50 to-gray-100  pt-16 pb-32 sm:pt-24 sm:pb-40">
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          >
          <h1 className="text-4xl tracking-tight font-extrabold bg-gradient-to-r from-gray-900 via-gray-600 to-gray-900 text-transparent bg-clip-text sm:text-4xl md:text-6xl">
              ...
              <div className="relative block w-full overflow-hidden">
                ...
                >
                  <Image
                    ...
                    width={440}
                    height={792}
                    className="max-lg:hidden w-3/5 md:w-4/5 mx-auto"
                  />
                </motion.div>
              </div>
            </div>
